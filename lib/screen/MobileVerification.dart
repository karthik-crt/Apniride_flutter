        ...
        child: Column(
          ...
          children: [
            ...
            BlocConsumer<LoginCubit, LoginState>(
              ...
              if (loginState is LoginSuccess) {
                setState(() {
                  _isVerifying = true; // Start verification loading
                });
                SharedPreferenceHelper.setMobile(mobile.text);
                SharedPreferenceHelper.setUserName(loginState.login.username);
                ...
                FirebaseAuth.instance.verifyPhoneNumber(
                  ...
                  verificationFailed: (FirebaseAuthException e) {
                    setState(() {
                      _isVerifying = false; // Stop loading on failure
                    });
                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) => OtpVerification(
                          ...
                          isOldUser: loginState.login.isOldUser,
                          phoneNumber: phoneNumber,
                        ),
                      ),
                    );
              ...
              if (loginState is LoginLoading || _isVerifying) {
                return SizedBox(
                  width: double.infinity,
                  child: ElevatedButton(
                      style: ElevatedButton.styleFrom(
